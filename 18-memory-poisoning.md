...
was allowed by the guardrail because the implementation relied on exact keyword matching.

This demonstrates a memory poisoning bypass using alternative phrasing.

## Recommendation

- Add regex-based detection
- Implement semantic matching
- Use an LLM Judge for memory validation
